...
const Skills = () => {
  return (
    <motion.div
      ...
      className="w-full flex  flex-row  gap-20"
    >
      <div className="w-full lgl:w-1/2">
        ...
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bg-black rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-full h-full bg-linear-to-r from-blue-600
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[90%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[60%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">0%</span>
              </motion.span>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[70%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">0%</span>
              </motion.span>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[95%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[80%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2  bg-black rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[75%] h-full bg-linear-to-r from-blue-600
                 via-pink-500 to-red-500 rounded-md relative"
              >
